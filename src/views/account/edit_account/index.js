...
const EditProfile = (props) => {
  ...
  useDocumentTitle("Edit Account | Dharmesh");
  useScrollTop();
  useEffect(() => {
    return () => {
      ...
      <div className="edit-user">
        ...
        <div className="user-profile-details">
          ...
          <Input
            ...
            maxLength={120}
            readOnly={isLoading}
            placeholder="eg: #245 Gujarat, India"
          ...
          />
          {field.mobile.error ? (
            <span className="input-message">{field.mobile.error}</span>
          ) : (
          ...
          <PhoneInput
            ...
            inputClass={`input-form d-block ${
              field.mobile.error ? "input-error" : ""
            }`}
